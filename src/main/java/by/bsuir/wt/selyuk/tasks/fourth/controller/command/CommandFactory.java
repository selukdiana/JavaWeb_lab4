...
import by.bsuir.wt.selyuk.tasks.fourth.controller.command.admin.AddRoomCommand;
import by.bsuir.wt.selyuk.tasks.fourth.controller.command.admin.DeoccupyRoomCommand;
import by.bsuir.wt.selyuk.tasks.fourth.controller.command.admin.ShowRoomsCommand;
import by.bsuir.wt.selyuk.tasks.fourth.controller.command.common.*;
import by.bsuir.wt.selyuk.tasks.fourth.controller.command.user.MainPageCommand;
import by.bsuir.wt.selyuk.tasks.fourth.controller.command.user.MakeOrderCommand;
